...
import spinner from "./assets/double-ring.gif";

const Playfield = ({ pairs }) => {
  const pairVisibleInMilliseconds = 1000;
  ...
  //const picsumApiUrl = "";
  const picsumApiUrl = 'https://picsum.photos/140/200'
